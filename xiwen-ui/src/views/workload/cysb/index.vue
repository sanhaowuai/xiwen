<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="sbglList">
      ...
      <el-table-column label="考核项" align="center" prop="khxmc" width="150" :show-overflow-tooltip="true" />
      <el-table-column label="工作时长" align="center" prop="gzsc" width="100"/>
      <el-table-column label="工作简述" align="center" prop="gzjs" :show-overflow-tooltip="true" />
...
<script>
  import { listSbglCysb, getSbgl, delSbgl, addSbgl, updateSbgl,
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        this.loading = true;
        listSbglCysb(this.queryParams).then(response => {
